...
def bubble_call(clean_binary, reference_binary, reference, outdir):
    ...
    subprocess.call(["cd " + outdir + "; mccortex63 join -q -m 8G -o " + clean_binary + "_plus_" + reference_binary +" ref/" + reference_binary +
                     " clean/" + clean_binary], stdout=subprocess.PIPE, shell=True)
    subprocess.call(["cd " + outdir + "; mccortex63 bubbles -q -m 8G -o " + clean_binary + "_bubbles.txt.gz --haploid 0 -S -f " +
    ...
    subprocess.call(["cd " + outdir + "; mccortex63 calls2vcf -q -F" + clean_binary +".sam -o " + clean_binary +
